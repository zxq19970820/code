package com.consumer.consumerdemo.one;
...
//        2设置连接工厂相关配置
        ...
        try {
            ...
            //5)接收消息  string queue   boolean autoAck   DeliverCallback deliverCallback   CancelCallback cancelCallback

//            queue：队列名称
//            autoAck：自动回复，true表示消费者接收到消息后告诉MQ消息已经被接收
//            deliverCallback  函数式接口，DeliverCallback对象，采取Lamdbda表达式
//            cancelCallback：取消
