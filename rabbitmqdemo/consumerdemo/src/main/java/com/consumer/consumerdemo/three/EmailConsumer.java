...
//            6交换机和队列绑定
            ...
            //7)接收消息    string queue   boolean autoAck   DeliverCallback deliverCallback   CancelCallback cancelCallback


//            queue：队列名称
//            autoAck：自动回复，true表示消费者接收到消息后告诉MQ消息已经被接收
//            deliverCallback  函数式接口，DeliverCallback对象，采取Lambda表达式
//            cancelCallback：取消
...
//                byte[]-->string
            ...
            channel.basicConsume(QUEQUE_Email, true, dc, cc);
