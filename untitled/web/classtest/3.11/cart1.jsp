...
<head>
    ...
    <script type="text/javascript" src="/untitled_war_exploded/classtest/3.11/js/jquery-3.3.1.js"></script>
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $(".plush").click(function () {
                ...
                //异步请求ajax
                //$.post(请求路径，请求参数，回调函数）
                $.post("/untitled_war_exploded/AjaxServlet",
                    {
                        cid: cid,
                        count: v
                    },
    ...
    <table width="1000px" border="1">
        ...
        <c:forEach items="${carts}" var="cart">
            <tr>
                ...
                <td><img src="/untitled_war_exploded/classtest/3.11/${cart.product.image}" width="100px"/></td>
                ...
                <td>
                    ...
                    <button type="button" class="cut" style="width: 20px;text-align: center;">-</button>
